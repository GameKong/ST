...
namespace ST.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        private const string CSharpCodeTemplateFileName = "Assets/GameMain/Scripts/Editor/DataTableGenerator/DataTableCodeTemplate.txt";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "ST");
